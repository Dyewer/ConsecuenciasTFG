...
func update_font_size():
	...
	# 3.1 Limpiamos el texto actual del label, que puede modificar el tamaño
	#     del rect que lo contiene si es muy grande y nos estropearía saber el
	#     tamaño del que disponemos
	...
	#print("Label Size: ", lbl_size, "  Size del recuadro: " , get_rect().size)
	...
	while font_size <= max_font_size:
		...
		font_size += 1
		#contador += 1
		#print("Finalizamos vuelta: ", contador, "  Tamaño del texto: ", text_size)
